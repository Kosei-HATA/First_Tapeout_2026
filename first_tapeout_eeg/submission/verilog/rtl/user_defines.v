...
// EEG AFE SoC pin map (2026-09-12 remap, io[0..4] stay system-reserved):
//   GPIO  5..13  io_in[5..13] : PHII..NPHIBI (chop clocks) + CLK16  (inputs)
//   GPIO 14..18  io_analog[0..4]: ELP ELN VCM_REF VP VN             (analog)
//   GPIO 19..24  io_analog[5..10]: unused                          (inputs)
//   GPIO 25      io_in[14]      : NCLK16                           (input)
//   GPIO 26..29  io_in[15..18]  : S8 S16 S32 S64                   (inputs)
//   GPIO 30..31  io_out[19..20] : BIT NBIT                         (outputs)
//   GPIO 32..37  unused                                          (inputs)
